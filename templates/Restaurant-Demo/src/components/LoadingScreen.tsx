    ...
    >
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-blur-char {
          ...
          opacity: 0;
          color: #2f2515;
          animation: blur-reveal-rest 1.2s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
        .animate-subtle-fade {
      ...
      <div className="relative z-10 flex flex-col items-center max-w-lg w-full px-8 text-center select-none">
        ...
        {/* Cinematic Subtitle */}
        <p className="animate-subtle-fade text-[9px] font-bold tracking-[0.4em] text-[#c5a059] uppercase">
